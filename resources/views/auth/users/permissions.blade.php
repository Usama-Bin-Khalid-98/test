                            ...
                            <table id="datatable" class="table table-bordered table-striped">
                                ...
                                @foreach($permissions as $permission)
                                    ...
                                    <tr>
                                        ...
                                        <td>@if($permission->status=='enabled')<span class="label gradient-bg-color">Enabled</span>@else
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="code" placeholder="Permission Code"
                                           name="code">
                                </div>
                            </div>
                            {{-- <div class="col-lg-1">
