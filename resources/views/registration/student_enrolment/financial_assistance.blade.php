@section('pageTitle', 'Financial Assistance')
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <p class="box-title">3.5.   Summarize the policy and process of financial assistance . Attach relevant policy documents as Appendix-3A. </p>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Financial Assistance</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                ...
                <form role="form" id="updateForm" >
                    <div class="modal-body">
                        <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">Summary</label>
                                    <textarea name="summary" id="edit_summary" value="{{old('edit_summary')}}" class="form-control"></textarea>
                                </div>
                            </div>
         ...
         $('#form').submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(next){
                        setTimeout(() => {
                            window.location = '/student-financial';
                        }, 1000);
                    }else{
                        location.reload();
                    }
...
$('#updateForm').submit(function (e) {
            ...
            $.ajax({
                url:'{{url("financial-assistance")}}/'+id,
                type:'POST',
                // dataType:"JSON",
                data: formData,
                cache:false,
