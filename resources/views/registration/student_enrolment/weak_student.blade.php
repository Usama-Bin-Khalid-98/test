@section('pageTitle', 'Weak Student')
@if(Auth::user())
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Weak Student</li>
            </ol>
        </section>
        <section class="content-header">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">3.7.    Summarize the strategy for identifying and counselling of academically weak students though faculty advisors and remedial classes.  Provide an analysis to show the impact of the strategy</h3>
              <!-- tools box -->
            ...
            <form>
                <div class="box-body pad">
                        ...
                        <input type="hidden" id="id" value="{{@$weak_student->id}}">
                </div>
                <div class="box-body pad">
                  <div class="col-md-12">
...
$('#update, #update-and-next').on('click', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(next){
                        setTimeout(() => {
                            window.location = '/personal-grooming';
                        }, 1000);
                    }
                },
