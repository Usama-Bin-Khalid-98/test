                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">3.3.  Provide the average class size of each program under review in Table 3.3.</h3>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Table 3.3 Class Size</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Edit Class Size. </h4>
                </div>
         ...
         $('#form').submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(next){
                        setTimeout(() => {
                            window.location = '/dropout-percentage';
                        }, 1000);
                    }else{
                        location.reload();
                    }
