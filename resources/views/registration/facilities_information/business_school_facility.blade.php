                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">@if($isActiveSAR) 7.5 @else 6.2 @endif Provide information about different facilities of the business school in Table @if($isActiveSAR) 7.5 @else 6.2 @endif.</h3>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Table @if($isActiveSAR) 7.5 @else 6.2 @endif Business schools’ resources</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
