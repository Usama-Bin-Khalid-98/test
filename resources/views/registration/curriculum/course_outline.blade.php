@section('pageTitle', 'Course Outline')
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <p class="box-title">2.8.   Provide course outlines  for one core course, one elective course and one support coursefor each program under review as Appendix-2A.</p>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Course Outline</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Edit Course Outline. </h4>
                </div>
