@section('pageTitle', 'Program Delivery')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Program Delivery</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <p class="box-title">2.15.  Provide the policy and implementation details of the process to monitor, evaluate and improve the quality of program    delivery. Attach any relevant policy as Appendix- 2C.</p>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Program Delivery</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Edit Program Delivery. </h4>
                </div>
         ...
         $('#form').submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(next){
                        setTimeout(() => {
                            window.location = '/question-paper';
                        }, 1000);
                    }else{
                        location.reload();
                    }
