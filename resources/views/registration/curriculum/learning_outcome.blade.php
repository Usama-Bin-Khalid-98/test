                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">2.5.  List the learning outcomes of each program under review in Table 2.5.</h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                   <label for="name">PLOs</label>
                                    <input type="text" name="plo[]" id="plo"  class="form-control">
                                </div>
                            </div>
                                @endfor
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Table 2.5. Program Learning Outcomes (PLO)</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="datatable" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>{{$portfolio->plo_name}}</td>
                                    <td>{{$portfolio->plo}}</td>
                                    <td><i class="badge {{$portfolio->status == 'active'?'bg-green':'bg-red'}}">{{$portfolio->status == 'active'?'Active':'Inactive'}}</i></td>
                               <td><i class="fa fa-trash text-info delete" data-id="{{$portfolio->id}}"></i> | <i data-row='{"id":{{$portfolio->id}},"program_id":"{{$portfolio->program_id}}","plo":"{{$portfolio->plo}}","status":"{{$portfolio->status}}"}' data-toggle="modal" data-target="#edit-modal" class="fa fa-pencil text-blue edit"></i></td>
                ...
                <form role="form" id="updateForm" >
                    <div class="modal-body">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                   <label for="name">Program learning outcomes</label>
                                    <input type="text" name="plo" id="edit_plo" value="{{old('edit_plo')}}"class="form-control">
                                </div>
