@section('pageTitle', 'Question Paper')
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <p class="box-title">2.16.  Provide the policy explaining the processes of moderation of question papers, conducting and monitoring     examination, and evaluating the quality of exam results as Appendix-2D.</p>
        ...
        $('#form').submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(next){
                        setTimeout(() => {
                            window.location ='/plagiarism-case';
                        }, 1000);
                    }else{
                        location.reload();
                    }
