@section('pageTitle', 'Managerial Skill')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> Managerial Skill </li>
            </ol>
        </section>
        <section class="content-header">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">2.12. Explain how the program curriculum helps develop managerialskills in Table 2.8.</h3>
...
{{--                                    </span>--}}
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Table 2.8. Managerial skills</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="datatable" class="table table-bordered table-striped">
                               ...
                               <td><i class="fa fa-trash text-info delete" data-id="{{$plan->id}}"></i> | <i class="fa fa-pencil text-blue edit" data-row='{"id":"{{$plan->id}}","skill":"{{$plan->skill}}", "course_title":"{{$plan->course_title}}", "status":"{{$plan->status}}"}' data-toggle="modal" data-target="#edit-modal"></i></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Edit Managerial Skill. </h4>
                </div>
                <form role="form" id="updateForm" >
                    <div class="modal-body">
                              <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">Main managerial skill</label>
                                    <input type="text" name="skill" id="edit_skill" readonly value="{{old('edit_skill')}}" class="form-control">
                                </div>
        ...
        $('#form').submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(next){
                        setTimeout(() => {
                            window.location = '/program-delivery-method';
                        }, 1000);
                    }else{
                        location.reload();
                    }
