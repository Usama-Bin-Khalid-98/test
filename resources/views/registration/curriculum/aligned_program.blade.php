@section('pageTitle', 'Aligned Program')
@if(Auth::user())
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Aligned Program</li>
            </ol>
        </section>
        <section class="content-header">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">2.7.    Explain how the POs and PLOs of each program under review are aligned with the vision and mission of the business school.</h3>
              <!-- tools box -->
            ...
            <form>
                <div class="box-body pad">
                        <textarea id="summary" name="summary" rows="10" cols="80">
                            {{@$aligned_program->summary}}
                        </textarea>
                        <input type="hidden" id="id" value="{{@$aligned_program->id}}">
                </div>
                <div class="box-body pad">
                  <div class="col-md-12">
  ...
  $(function () {
    ...
    <script type="text/javascript">
        ...
        $('.select2').select2()
         ...
         <?php if(@$aligned_program->id==null) { ?>
$('#update, #update-and-next').on('click', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(next){
                        setTimeout(() => {
                            window.location = '/course-outline';
                        }, 1000);
                    }
                },
