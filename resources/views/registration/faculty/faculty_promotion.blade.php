@section('pageTitle', 'Faculty Promotion')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Faculty Promotion</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <p class="box-title">4.7  Attach policy documents related to faculty recruitment, retention, promotion and annual evaluation as Appendix-4B.</p>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Faculty Promotion</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Edit Faculty Promotion. </h4>
                </div>
         ...
         $('#form').submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(next){
                        setTimeout(() => {
                            window.location = '/faculty-workshop';
                        }, 1000);
                    }else{
                        location.reload();
                    }
