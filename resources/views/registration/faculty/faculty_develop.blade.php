                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <p class="box-title">4.9 Attach faculty development policy as Appendix-4C.</p>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Faculty Development</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
         ...
         $('#form').submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(next){
                        setTimeout(() => {
                            window.location = '/consultancy-project';
                        }, 1000);
                    }else{
                        location.reload();
                    }
