                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <p class="box-title">Provide organograms of the business school and the parent institution as Appendix-1F.</p>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Parent Institution</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
    ...
    <script type="text/javascript">
        ...
        $('.select2').select2()
         ...
         $('#form').submit(function (e) {
            ...
            $.ajax({
                url:'{{url("strategic/parent-institution")}}',
                type:'POST',
                data: formData,
                cache:false,
                contentType:false,
...
$('#updateForm').submit(function (e) {
            ...
            $.ajax({
                url:'{{url("strategic/parent-institution")}}/'+id,
                type:'POST',
                // dataType:"JSON",
                data: formData,
                cache:false,
