                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Approval of Strategic Plan  Form</h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="contact_no" value="" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="name">Approving Authority</label>
                                    <input type="text" name="authority" value="" class="form-control">
                                </div>
                            </div>
