    ...
    <section class="invoice" style="border-left: 4px solid #a7a168;border-top: 4px solid #a7a168;border-radius: 41px 0px;">
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <p style="margin: 0px 10px 0px 10px;font-size:16px">CC: {{@$nbeacInfo->director}} (Program Director-NBEAC)</p>
                <p style="margin: 0px 10px 0px 10px;font-size:16px">CC: {{@$nbeacInfo->chairman}} (Chairman –NBEAC)</p>
            </div>
