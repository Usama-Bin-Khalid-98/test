            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div>
                        ...
                        <div class="col col-sm-12 col-md-10 col-lg-10">
                            <p class="left">1.   Before starting the registration application, please go through the guidelines given in Section III of the NBEAC Accreditation Process Manual<a href="https://nbeac.org.pk/index.php/accreditation-2/policies-and-procedures"> <span style="color: blue"> https://nbeac.org.pk/index.php/accreditation-2/policies-and-procedures</span></a> in order to ensure that the application is prepared in accordance with these guidelines.</p>
