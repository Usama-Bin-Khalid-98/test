@section('pageTitle', 'Environmental Protection')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Environmental Protection</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <p class="box-title">6.3    Enlist activities aimed at environmental protection and sustainability in Table 6.3. Attach policy on environmental protection as Appendix-6B.</p>
                    ...
                    <i class="fa fa-calendar"></i>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="activity_desc" id="activity_desc"  class="form-control">
                                </div>
                            </div>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Table 6.3 Environment Protection List</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Edit Environmental Protection. </h4>
                </div>
                <form role="form" id="updateForm" >
                    ...
                    <i class="fa fa-calendar"></i>
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">Activity Description</label>
                                    <input type="text" name="activity_desc" id="edit_activity_desc" value="{{old('edit_activity_desc')}}" class="form-control">
                                </div>
                              </div>
    ...
    <script type="text/javascript">
      ...
      autoclose:true
         ...
         $('#form').submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(next){
                        setTimeout(() => {
                            window.location = '/formal-relationship';
                        }, 1000);
                    }else{
                        location.reload();
                    }
         ...
         $('.edit').on('click', function () {
            ...
            $('#edit_activity_desc').val(data.activity_desc);
...
$('#updateForm').submit(function (e) {
            ...
            let activity_desc = $('#edit_activity_desc').val();
            let id = $('#edit_id').val();

            let status = $('input[name=edit_status]:checked').val();
            let isCompleted = $('input[name=edit_isComplete]:checked').val();
            !date?addClass('edit_date'):removeClass('edit_date');
            !activity_desc?addClass('edit_activity_desc'):removeClass('edit_activity_desc');
