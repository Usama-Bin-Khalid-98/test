...
@if(Auth::user())
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Generate Invoice for Accreditation.</h4>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Department Accreditation invoices.</h3>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Add Invoice Slip for Accreditation. </h4>
                </div>
                <div class="modal-body">
    ...
    <script type="text/javascript">
        ...
        $('#Invoice').on('submit', function (e) {
            ...
            $.ajax({
                url:'{{url("accreditation-invoices")}}/'+id,
                type:'POST',
                data: formData,
                cache:false,
                contentType:false,
        ...
        $('#add').on('click', function (e) {
            ...
            // Yes button callback
            $.ajax({
                url:'{{url("accreditation-invoices")}}',
                type:'POST',
                data: {
