            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Select Proposed Peer Reviewers and Schedule Peer Review Visit. </h4>
                </div>
...
{{--                        </div>--}}
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" name="schedule" id="schedule" class="btn btn-info">Submit</button>
                    </div>
                </form>
            </div>
            <!-- /.modal-content -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Set Peer Review Visit availability Date. </h4>
                </div>
                <form role="form" id="updateForm" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $.ajax({
            url:"{{url('PeerReviewScheduler')}}/"+{{request()->route('id')}},
            type:"get",
            data: {events:'events'},
            beforeSend: function(){
...
<script>
    ...
    $(function () {
        ...
        $('#confirmDate').on('change', function () {
            ...
            $.ajax({
                url:"{{url('changePeerReviewConfirmStatus')}}",
                type:"post",
