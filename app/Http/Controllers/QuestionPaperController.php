...
class QuestionPaperController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
//            dd($fileName);
                if(QuestionPaper::where(['campus_id' => Auth::user()->campus_id, 'department_id' => Auth::user()->department_id])->exists()){
                    return response()->json(['message'=> 'Question paper already exists.'], 422);
                }
                $path = ''; $imageName = '';
