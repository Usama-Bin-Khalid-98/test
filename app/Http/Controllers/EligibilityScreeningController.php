...
//            '<p>Reference to the registration application received for accreditation dated August 23, 2019, this is to inform you that the Initial Eligibility Screening (IES) is completed by the Eligibility Screening Committee (ESC) in the 8th ESC Meeting held on Nov 28, 2019.</p>'.
            ...
            '<ol>'.
                ...
                '<li>It is requested to send us the completed Self-Assessment Proformae for BBA Hons. Program within 12 weeks. The due date for SAR submission is March 02, 2020. The Self-Assessment Proformae can be downloaded from: <a href="http://www.nbeac.org.pk/index.php/accreditation-2/policies-and-procedures">http://www.nbeac.org.pk/index.php/accreditation-2/policies-and-procedures</a>. It is recommended that the university refers to the NBEAC Accreditation Process Manual <a href="https://nbeac.org.pk/index.php/accreditation-2/policies-and-procedures">https://nbeac.org.pk/index.php/accreditation-2/policies-and-procedures</a> for details regarding the important aspects and requirements for NBEAC accreditation.</li>'.
