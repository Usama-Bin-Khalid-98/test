...
class ComplaintResolutionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
//            dd($fileName);
                if(ComplaintResolution::where(['campus_id' => Auth::user()->campus_id, 'department_id' => Auth::user()->department_id])->exists()){
                    return response()->json(['message'=> 'Complaint resolution already exists.'], 422);
                }
                $path = ''; $imageName = '';
