...
class AuditReportController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
//            dd($fileName);
                if(AuditReport::where(['campus_id' => Auth::user()->campus_id, 'department_id' => Auth::user()->department_id,])->exists()){
                    return response()->json(['error' => 'Audit Report already exists'], 422);
                }
                $path = ''; $imageName = '';
